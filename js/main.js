window.addEventListener("load", () => {
    ...
    let cat1name = "Category 1";
    //this is a description of this category
    let c1txt = "stuff about category 1";
    ...
    let cat1p2name = "Category 1 page 2";
    let c1p2txt = "stuff about category 1";
    c1p2 = {
        i1p2: {
            //name of the first item in this category 
            name: "test product",
